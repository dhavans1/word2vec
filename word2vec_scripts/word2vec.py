...
def train(train_data, do_train=True):
    ...
    if do_train:
        ...
        min_word_count = 10 #minimum count of words in vocabulary
        ...
        model_name = "kaggle_word2vec_model_"+str(num_features)+"features_"+str(min_word_count)+"minWords_"+str(context)+"contextWindow"
...
def main(do_preprocess=False):
    ...
    train(train_data, do_train=False)
    
    print("Training Phase successful")
    
    #Testing
    model = word2vec.Word2Vec.load("kaggle_word2vec_model_300features_40minWords_10contextWindow")
    
    print(model.most_similar(['queen']))  
    print(model.doesnt_match("wisdom experience knowledge naive".split()))
